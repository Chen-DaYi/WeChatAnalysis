...
class WeChat:
    ...
    def __init__(self):
        self.BASE_URL = 'http://127.0.0.1:57270/wechat-plugin/'
...
if __name__ == '__main__':
    wechat = WeChat()
    # print(wechat.search_user_by_keyword('Apple'))  # 搜索显示名称为Apple的联系人/群组（速度较慢）
    print(wechat.search_user_by_name('Apple'))  # 搜索显示名称为Apple的联系人/群组（速度较快）
    # print(wechat.get_chat_log_by_name('Apple', 5))  # 返回与Apple最近的五条聊天记录
